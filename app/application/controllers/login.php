...
class Login extends CI_Controller {
    ...
    private function send_reset_password_email($email, $name)
    {
        ...
        $params = array(
            ...
            'html'      => '<p>Dear '.$name.'</p><p>A password reset link has been requested for CellKulture.com using this email account. Click the link below to reset password</p><p><a href="http://www.cellkulture.com/'.base_url().'/login/reset_password_form/'.$email.'/'.$email_code.'">Reset Your Password</a><p>If you did not request a password reset simply ignore this email or report it to info@cellkulture.com</p><p>The CellKulture Team</p>',
            'text'      => 'Dear'.$name.'. A password reset link has been requested for CellKulture.com using this email account. Please copy and paste this link into your browser to reset password "http://www.cellkulture.com/'.base_url().'/login/reset_password_form/'.$email.'/'.$email_code.'. If you did not request a password reset simply ignore this email or report it to info@cellkulture.com. The CellKulture Team',
